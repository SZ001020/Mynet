"""Plan7-A: in-ViT RGB/DSM MMAdapter with DSM edge/slope prompt branch."""
...
def inject_mm_adapters(
    ...
    blk_info = f"blocks={block_indices}" if block_indices else "all blocks"
    print(
        f"  Injected {replaced} Plan7 prompt MMAdapter blocks [{blk_info}] "
