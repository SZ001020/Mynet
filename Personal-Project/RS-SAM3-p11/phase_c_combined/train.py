#!/usr/bin/env python3
"""P11-C: nDSM + tree/grass boundary-weighted loss (combined, from scratch, seed=42)."""
...
def main():
    ...
    out_dir = os.path.join(args.output, f"plan11_c_combined_{args.dataset}_{ts}")
    os.makedirs(out_dir, exist_ok=True)
    json.dump(vars(args), open(os.path.join(out_dir, "config.json"), "w"), indent=2)

    print("P11-C: nDSM + veg boundary loss (from scratch, seed=42)")
