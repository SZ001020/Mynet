...
sys.path.insert(0, SE); sys.path.insert(0, '/root/Mynet/Personal-Project/RS-SAM3-p4')
sys.path.insert(0, '/root/Mynet/Personal-Project/RS-SAM3-p3r'); sys.path.insert(0, '/root/Mynet/Personal-Project/RS-SAM-p3b')
