...
def main():
    ...
    parser.add_argument('--model', default='rgb', choices=['rgb', 'dsm'])
    ...
    model = LoRASAM3UNetFormer(sam3, lora_rank=8, lora_alpha=16, num_classes=NUM_CLASSES,
                               dropout=0.1, use_dsm=use_dsm).cuda()
