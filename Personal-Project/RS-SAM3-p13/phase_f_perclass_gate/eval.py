#!/usr/bin/env python3
"""P13-F 256x256 sliding window evaluation."""
...
def main():
    ...
    print(f"P13-F eval: {args.dataset}")
    ...
    out = args.output or os.path.join(os.path.dirname(args.checkpoint), "eval_256_vaihingen_plan13_f.json")
