"""DSM edge/slope prompt encoder for Plan7-A."""
...
def dsm_edge_slope(dsm: torch.Tensor) -> torch.Tensor:
    """Create two prompt channels from DSM: Sobel slope and Laplacian edge."""
    ...
    return robust_unit(torch.cat([slope, edge], dim=1))


class PromptEncoder(nn.Module):
    """Encode DSM edge/slope prompt to SAM3 ViT patch tokens."""
