#!/usr/bin/env python3
"""Evaluate CTRL baseline with 256x256 MFNet sliding-window protocol."""
...
from train_ctrl import dataset_paths, load_sam3  # noqa: E402
...
def main():
    ...
    print(f"Plan8 CTRL eval: {args.dataset}")
    ...
    out = args.output or os.path.join(os.path.dirname(args.checkpoint), f"eval_256_{args.dataset}_plan8_ctrl.json")
