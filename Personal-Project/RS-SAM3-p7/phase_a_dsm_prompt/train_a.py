#!/usr/bin/env python3
"""Train Plan7-A: DSM edge/slope prompt on top of Phase1 full MMAdapter."""
...
def main():
    ...
    out_dir = os.path.join(args.output, f"plan7_phase_a_dsm_prompt_{args.dataset}_{ts}")
    os.makedirs(out_dir, exist_ok=True)
    json.dump(vars(args), open(os.path.join(out_dir, "config.json"), "w"), indent=2)

    print("Plan7-A: DSM edge/slope prompt")
