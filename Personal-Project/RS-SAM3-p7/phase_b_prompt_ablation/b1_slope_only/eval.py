#!/usr/bin/env python3
"""Evaluate Plan7-B1 with the 256x256 MFNet sliding-window protocol."""
...
PHASE_DIR = f"{BASE}/Personal-Project/RS-SAM3-p7/phase_b_prompt_ablation/b1_slope_only"
...
from train_b1 import dataset_paths, load_sam3  # noqa: E402
...
def main():
    ...
    print(f"Plan7-B1 eval: {args.dataset}")
    ...
    out = args.output or os.path.join(os.path.dirname(args.checkpoint), f"eval_256_{args.dataset}_plan7_b1.json")
