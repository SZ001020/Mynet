#!/usr/bin/env python3
"""Evaluate Plan7-B3 with the 256x256 MFNet sliding-window protocol."""
...
from train_b3 import dataset_paths, load_sam3  # noqa: E402
...
def main():
    ...
    print(f"Plan7-B3 eval: {args.dataset}")
    ...
    out = args.output or os.path.join(os.path.dirname(args.checkpoint), f"eval_256_{args.dataset}_plan7_b3.json")
