#!/usr/bin/env python3
"""Train Plan7-B3: DSM slope/edge/curvature prompt ablation."""
...
PHASE_DIR = f"{BASE}/Personal-Project/RS-SAM3-p7/phase_b_prompt_ablation/b3_slope_edge_curvature"
...
def main():
    ...
    parser.add_argument(
        "--init-from",
        default="/root/autodl-tmp/runs/plan6_phase1_mm_adapter_vaihingen_20260509_202720/best_model.pt",
    )
    ...
    out_dir = os.path.join(args.output, f"plan7_phase_b3_slope_edge_curvature_{args.dataset}_{ts}")
    os.makedirs(out_dir, exist_ok=True)
    json.dump(vars(args), open(os.path.join(out_dir, "config.json"), "w"), indent=2)

    print("Plan7-B3: DSM slope/edge/curvature prompt")
