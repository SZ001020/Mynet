...
export SSRS_BATCH_SIZE="${SSRS_BATCH_SIZE:-12}"
...
export SSRS_MFNET_MICRO_BS="${SSRS_MFNET_MICRO_BS:-4}"
...
# Default fine-grid around initial training setting (bdy=0.1, obj=1.0).
B_LAMBDAS="${SSRS_GRID_LAMBDA_BDY:-0.08,0.10,0.12}"
O_LAMBDAS="${SSRS_GRID_LAMBDA_OBJ:-0.8,1.0,1.2}"
